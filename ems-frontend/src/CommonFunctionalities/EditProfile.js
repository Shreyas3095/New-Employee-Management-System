...
export default function EditProfile() {
  ...
  return (
    <div className='container'>
      {status ? <div className='btn bg-primary'><h5>Profile Saved</h5></div>
        :
        <div class="">
          <form className=''>
            <div class="mb-3">
              <label for="firstname" className="form-label ">First Name :</label>
              <input type="text" id="firstname" className='form-control'  placeholder={emp.firstName}
                value={firstName} onChange={(e) => { setFirstName(e.target.value) }}
              />
            </div>
            <div class="mb-3">
              <label for="lastname" className="form-label">Last Name :</label>
              <input type="text"  id="lastname" className='form-control' placeholder={emp.lastName}
                value={lastName} onChange={(e) => { setLastName(e.target.value) }}
              />
            </div>
            <div class="mb-3" >
              <label for="address" className="form-label">Address :</label>
              <input type="text" id="address"  className='form-control' placeholder={emp.address}
                value={address} onChange={(e) => { setAddress(e.target.value) }}
              />
            </div>
            <div class="mb-3 w-50  position-relative">
              <label for="phone" class="form-label">Phone :</label>
              <input type="text"  id="phone" className='form-control' placeholder={emp.phone}
